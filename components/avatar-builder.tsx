...
export const EYE_COLORS: {
  value: NonNullable<AvatarData['eyeColor']>
  color: string
  label: string
}[] = [
...
export const OUTFIT_COLORS: {
  value: NonNullable<AvatarData['outfitColor']>
  color: string
  label: string
}[] = [
...
function AvatarPreview({ avatar }: { avatar: Partial<AvatarData> }) {
  ...
  const showDress =
    outfitStyle === 'dress' || (isGirl && outfitStyle !== 'pajama' && outfitStyle !== 'casual')
  ...
  const eyeShadow = blend(eyeHex, '#000000', 0.3)
  ...
  return (
    ...
    >
          ...
          {shoesStyle === 'boots' && (
            <>
              <rect
                ...
                height="26"
                rx="8"
                fill={blend(shoeMain, '#000000', 0.08)}
              />
              <rect
                x="109"
                y="218"
      ...
      {outfitStyle === 'pajama' && (
        <path
          d="M 72 167 Q 86 177 100 167 Q 114 177 128 167"
          stroke="white"
          strokeWidth="2.5"
          fill="none"
          opacity="0.42"
      ...
      <rect
        ...
        rx="10"
        fill={outfitHex}
        transform="translate(62,153) rotate(18)"
      />
      <rect
        x="-10"
        y="0"
        ...
        rx="10"
        fill={outfitHex}
        transform="translate(138,153) rotate(-18)"
      />
      ...
      {hairStyle === 'short' && <ellipse cx="100" cy="68" rx="55" ry="46" fill="url(#av-hair)" />}
      {hairStyle === 'pigtails' && (
        <>
      ...
      {hairStyle === 'bun' && <ellipse cx="100" cy="72" rx="54" ry="52" fill="url(#av-hair)" />}
      {hairStyle === 'braids' && <ellipse cx="100" cy="70" rx="54" ry="50" fill="url(#av-hair)" />}
      {hairStyle === 'curly' && (
        <>
      ...
      {hairStyle === 'braids' && (
        <>
          ...
          <path
            d="M 56 108 L 46 120 L 56 132 L 46 144 L 56 156 L 46 166 L 56 174"
            stroke={hairHex}
            strokeWidth="12"
            fill="none"
            strokeLinecap="round"
          ...
          <path
            d="M 144 108 L 154 120 L 144 132 L 154 144 L 144 156 L 154 166 L 144 174"
            stroke={hairHex}
            strokeWidth="12"
            fill="none"
            strokeLinecap="round"
          ...
          <path
            d="M 50 119 L 56 125 M 50 131 L 56 137 M 50 143 L 56 149 M 50 155 L 56 161 M 50 165 L 56 170"
            stroke={blend(hairHex, '#ffffff', 0.35)}
            strokeWidth="1.8"
            fill="none"
            strokeLinecap="round"
          />
          <path
            d="M 150 119 L 144 125 M 150 131 L 144 137 M 150 143 L 144 149 M 150 155 L 144 161 M 150 165 L 144 170"
            stroke={blend(hairHex, '#ffffff', 0.35)}
            strokeWidth="1.8"
            fill="none"
            strokeLinecap="round"
      ...
      {/* ── NOSE ── */}
      {noseStyle === 'button' && <ellipse cx="100" cy="104" rx="6" ry="4" fill={skinShadow} />}
      {noseStyle === 'small' && (
        <>
          <circle cx="95" cy="104" r="3.5" fill={skinShadow} />
          <circle cx="105" cy="104" r="3.5" fill={skinShadow} />
          <path
            d="M 95 101 Q 100 98 105 101"
            stroke={skinShadow}
            strokeWidth="1.5"
            fill="none"
            strokeLinecap="round"
      ...
      {lipStyle === 'thin' && (
        <>
          ...
          />
          <path
            d="M 88 117 Q 100 113 112 117"
            stroke="rgba(201,112,112,0.45)"
            strokeWidth="1.5"
            fill="none"
            strokeLinecap="round"
          />
      ...
      {(lipStyle === 'medium' || !lipStyle) && (
        <>
          ...
          <path
            d="M 86 117 Q 100 113 114 117"
            stroke="rgba(201,112,112,0.42)"
            strokeWidth="1.5"
            fill="none"
            strokeLinecap="round"
          />
      ...
      {lipStyle === 'full' && (
        <>
          <path
            d="M 84 117 Q 92 112 100 114 Q 108 112 116 117 Q 108 115 100 116 Q 92 115 84 117 Z"
            fill="#D47A7A"
          />
          <path d="M 84 117 Q 100 132 116 117 Q 110 126 100 127 Q 90 126 84 117 Z" fill="#E89090" />
          <path
            d="M 84 117 Q 92 112 100 114 Q 108 112 116 117"
            stroke="#C06060"
            strokeWidth="1.2"
            fill="none"
            strokeLinecap="round"
